...
#ifndef UPNEXT_SWIFT_H
#define UPNEXT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UpNext",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class NSString;
SWIFT_CLASS("_TtC6UpNext11AppDelegate")
...
@interface AppDelegate (SWIFT_EXTENSION(UpNext)) <UNUserNotificationCenterDelegate>
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center didReceiveNotificationResponse:(UNNotificationResponse * _Nonnull)response withCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
@end

@class CPTemplateApplicationScene;
@class CPInterfaceController;
SWIFT_CLASS("_TtC6UpNext20CarPlaySceneDelegate")
...
SWIFT_CLASS("_TtC6UpNext15DownloadManager")
...
@class NSXMLParser;
SWIFT_CLASS("_TtC6UpNext10OPMLParser")
...
SWIFT_CLASS("_TtC6UpNext24PhoneWatchSyncController")
@interface PhoneWatchSyncController : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface PhoneWatchSyncController (SWIFT_EXTENSION(UpNext)) <WCSessionDelegate>
...
SWIFT_CLASS("_TtC6UpNext13PodcastParser")
...
SWIFT_CLASS("_TtC6UpNext22SideloadingCoordinator")
@interface SideloadingCoordinator : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSOperationQueue;
SWIFT_CLASS("_TtC6UpNext26SideloadingFolderPresenter")
@interface SideloadingFolderPresenter : NSObject <NSFilePresenter>
...
SWIFT_CLASS("_TtC6UpNext17SubscriptionActor")
@interface SubscriptionActor : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC6UpNext19SubscriptionManager")
