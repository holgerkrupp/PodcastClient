...
#ifndef UPNEXTWATCH_SWIFT_H
#define UPNEXTWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UpNextWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11UpNextWatch14WatchSyncStore")
@interface WatchSyncStore : NSObject
...
@interface WatchSyncStore (SWIFT_EXTENSION(UpNextWatch)) <NSURLSessionDownloadDelegate>
...
@class NSString;
@class WCSessionFile;
@interface WatchSyncStore (SWIFT_EXTENSION(UpNextWatch)) <WCSessionDelegate>
