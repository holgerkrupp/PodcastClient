...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let _6Colors = DeveloperToolsSupport.ImageResource(name: "6Colors", bundle: resourceBundle)
    ...
    static let blue = DeveloperToolsSupport.ImageResource(name: "blue", bundle: resourceBundle)
    ...
    static let green = DeveloperToolsSupport.ImageResource(name: "green", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "6Colors" asset catalog image.
    static var _6Colors: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: ._6Colors)
#else
        .init()
#endif
    }

    /// The "LaunchMark" asset catalog image.
    static var launchMark: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .launchMark)
#else
        .init()
#endif
    }

    /// The "blue" asset catalog image.
    ...
    /// The "green" asset catalog image.
    static var green: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .green)
#else
        .init()
...
#if !targetEnvironment(macCatalyst)
        .init(resource: .purple)
#else
        .init()
#endif
    }

    /// The "red" asset catalog image.
    ...
    /// The "yellow" asset catalog image.
    static var yellow: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .yellow)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "6Colors" asset catalog image.
    static var _6Colors: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: ._6Colors)
#else
        .init()
    ...
    /// The "LaunchMark" asset catalog image.
    static var launchMark: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .launchMark)
#else
        .init()
    ...
    /// The "green" asset catalog image.
    static var green: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .green)
#else
        .init()
    ...
    /// The "yellow" asset catalog image.
    static var yellow: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .yellow)
#else
        .init()
