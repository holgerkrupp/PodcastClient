...
class ModelContainerManager: ObservableObject {
    ...
    init() {
        ...
        do {
            container = try ModelContainer(for: Podcast.self, Episode.self, EpisodeMetaData.self, Playlist.self, PlaylistEntry.self, Chapter.self, configurations: configuration)
        } catch {
